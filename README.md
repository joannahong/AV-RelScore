...
## Overview
This repository provides the visual corruption modeling code for testing audio-visual speech recognition of LRS2 and LRS3 datasets.
...
### Visual corruption with occlusion patch

### Visual corruption with noise
